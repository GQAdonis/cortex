...
var init_config = __esm({
  "src/config.ts"() {
    "use strict";
    init_zod();
    StatuslineConfigSchema = external_exports.object({
...
var import_sql, dbInstance, SQL, fts5Available, initPromise, MAX_BACKUPS;
...
__export(embeddings_exports, {
  ...
  embedBatchWithResult: () => embedBatchWithResult,
...
var MODEL_NAME, EMBEDDING_DIM, PASSAGE_PREFIX, QUERY_PREFIX, embedder, initPromise2, pipelineFunc;
